...
# Get fruit names and the values used for the API search
my_dataframe = (
...
# Create the list displayed in the multiselect
fruit_options = pd_df["FRUIT_NAME"].tolist()


# Let the customer select up to five fruits
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        # Keep the ending space because the course grader expects
        # the value created using this method.
